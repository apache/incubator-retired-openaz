...
public class FunctionDefinitionXPathTest {
    ...
    String reqStrContentMdRecord = " <Content>"
                                   + "<md:record>"
                                   + "<md:hospital_info>"
                                   ...
                                   + "</md:diagnosis>" + "<md:date>2000-10-05</md:date>"
                                   + "<md:malignancy type=\"yes\"/>" + "</md:pathological_diagnosis>"
                                   + "</md:diagnosis_info>  " + " </md:record>" + "</Content>";
    String reqStrMalformedContent = " <Content>" + "<md:record>" + "<md:hospital_info>"
                                    + "<md:name>ABC Hospital</md:name>" + "<md:malignancy type=\"yes\"/>"
                                    + "</Content>";
    ...
    String reqStrResourceAllEnd = reqStrResourceEnd + reqStrActionStart + reqStrActionEnd
                                  + reqStrEnvironmentStartEnd + reqStrMainEnd;
    ...
    // Name Spaces used in the XML as part of these examples (copied from the Conformance tests) - needed for
    // compiling XPaths
    ...
    public FunctionDefinitionXPathTest() {
        try {
            ...
            XPathExpressionWrapper xSlashSlashMdRecord = new XPathExpressionWrapper(
                                                                                    xpath
                                                                                        .compile("//md:record"));
            ...
            XPathExpressionWrapper xSlashSlashMdMalignancy = new XPathExpressionWrapper(
                                                                                        xpath
                                                                                            .compile("//md:malignancy"));
            XPathExpressionWrapper xNotInRequest = new XPathExpressionWrapper(
                                                                              xpath
                                                                                  .compile("value_Not_in_request"));
            XPathExpressionWrapper xSlashSlashMdRecordSlashStar = new XPathExpressionWrapper(
                                                                                             xpath
                                                                                                 .compile("//md:record/*"));
            XPathExpressionWrapper xMdPatientInfo = new XPathExpressionWrapper(
                                                                               xpath
                                                                                   .compile("md:patient_info"));

            // create Function Attributes out of the XPathExpressions
            attrXnull = new FunctionArgumentAttributeValue(null);
            attrXEmpty = new FunctionArgumentAttributeValue(
                                                            DataTypes.DT_XPATHEXPRESSION
                                                                .createAttributeValue(xEmpty));
            attrXNoCategory = new FunctionArgumentAttributeValue(
                                                                 DataTypes.DT_XPATHEXPRESSION
                                                                     .createAttributeValue(xSlashSlashMdRecord));
            attrXNoValue = new FunctionArgumentAttributeValue(
                                                              DataTypes.DT_XPATHEXPRESSION
                                                                  .createAttributeValue(xEmpty,
                                                                                        new IdentifierImpl(
                                                                                                           "urn:oasis:names:tc:xacml:3.0:attribute-category:resource")));
            attrXSlashSlashMdRecord = new FunctionArgumentAttributeValue(
                                                                         DataTypes.DT_XPATHEXPRESSION
                                                                             .createAttributeValue(xSlashSlashMdRecord,
                                                                                                   new IdentifierImpl(
                                                                                                                      "urn:oasis:names:tc:xacml:3.0:attribute-category:resource")));
            attrXSlashSlashStar = new FunctionArgumentAttributeValue(
                                                                     DataTypes.DT_XPATHEXPRESSION
                                                                         .createAttributeValue(xSlashSlashStar,
                                                                                               new IdentifierImpl(
                                                                                                                  "urn:oasis:names:tc:xacml:3.0:attribute-category:resource")));
            attrXSlashSlashMdName = new FunctionArgumentAttributeValue(
                                                                       DataTypes.DT_XPATHEXPRESSION
                                                                           .createAttributeValue(xSlashSlashMdName,
                                                                                                 new IdentifierImpl(
                                                                                                                    "urn:oasis:names:tc:xacml:3.0:attribute-category:resource")));
            attrXSlashSlashMdMalignancy = new FunctionArgumentAttributeValue(
                                                                             DataTypes.DT_XPATHEXPRESSION
                                                                                 .createAttributeValue(xSlashSlashMdMalignancy,
                                                                                                       new IdentifierImpl(
                                                                                                                          "urn:oasis:names:tc:xacml:3.0:attribute-category:resource")));
            attrXNotInRequest = new FunctionArgumentAttributeValue(
                                                                   DataTypes.DT_XPATHEXPRESSION
                                                                       .createAttributeValue(xNotInRequest,
                                                                                             new IdentifierImpl(
                                                                                                                "urn:oasis:names:tc:xacml:3.0:attribute-category:resource")));

            attrXSlashSlashMdRecordSlashStar = new FunctionArgumentAttributeValue(
                                                                                  DataTypes.DT_XPATHEXPRESSION
                                                                                      .createAttributeValue(xSlashSlashMdRecordSlashStar,
                                                                                                            new IdentifierImpl(
                                                                                                                               "urn:oasis:names:tc:xacml:3.0:attribute-category:resource")));
            attrXMdPatientInfo = new FunctionArgumentAttributeValue(
                                                                    DataTypes.DT_XPATHEXPRESSION
                                                                        .createAttributeValue(xMdPatientInfo,
                                                                                              new IdentifierImpl(
                                                                                                                 "urn:oasis:names:tc:xacml:3.0:attribute-category:resource")));
            ...
            attrStrNoCategory = new FunctionArgumentAttributeValue(
                                                                   DataTypes.DT_STRING
                                                                       .createAttributeValue("//md:record"));
            attrStrNoValue = new FunctionArgumentAttributeValue(
                                                                DataTypes.DT_STRING
                                                                    .createAttributeValue("",
                                                                                          new IdentifierImpl(
                                                                                                             "urn:oasis:names:tc:xacml:3.0:attribute-category:resource")));
            attrStrSlashSlashMdRecord = new FunctionArgumentAttributeValue(
                                                                           DataTypes.DT_STRING
                                                                               .createAttributeValue("//md:record",
                                                                                                     new IdentifierImpl(
                                                                                                                        "urn:oasis:names:tc:xacml:3.0:attribute-category:resource")));
            attrStrSlashSlashStar = new FunctionArgumentAttributeValue(
                                                                       DataTypes.DT_STRING
                                                                           .createAttributeValue("//*",
                                                                                                 new IdentifierImpl(
                                                                                                                    "urn:oasis:names:tc:xacml:3.0:attribute-category:resource")));
            attrStrSlashSlashMdName = new FunctionArgumentAttributeValue(
                                                                         DataTypes.DT_STRING
                                                                             .createAttributeValue("//md:name",
                                                                                                   new IdentifierImpl(
                                                                                                                      "urn:oasis:names:tc:xacml:3.0:attribute-category:resource")));
            attrStrSlashSlashMdMalignancy = new FunctionArgumentAttributeValue(
                                                                               DataTypes.DT_STRING
                                                                                   .createAttributeValue("//md:malignancy",
                                                                                                         new IdentifierImpl(
                                                                                                                            "urn:oasis:names:tc:xacml:3.0:attribute-category:resource")));
            attrStrNotInRequest = new FunctionArgumentAttributeValue(
                                                                     DataTypes.DT_STRING
                                                                         .createAttributeValue("value_Not_in_request",
                                                                                               new IdentifierImpl(
                                                                                                                  "urn:oasis:names:tc:xacml:3.0:attribute-category:resource")));

            attrStrSlashSlashMdRecordSlashStar = new FunctionArgumentAttributeValue(
                                                                                    DataTypes.DT_STRING
                                                                                        .createAttributeValue("//md:record/*",
                                                                                                              new IdentifierImpl(
                                                                                                                                 "urn:oasis:names:tc:xacml:3.0:attribute-category:resource")));
            attrStrMdPatientInfo = new FunctionArgumentAttributeValue(
                                                                      DataTypes.DT_STRING
                                                                          .createAttributeValue("md:patient_info",
                                                                                                new IdentifierImpl(
                                                                                                                   "urn:oasis:names:tc:xacml:3.0:attribute-category:resource")));

            attrBadType = new FunctionArgumentAttributeValue(
                                                             DataTypes.DT_STRING
                                                                 .createAttributeValue("some string"));

            // Request objects
            // to create a Request object the easiest way is to put the xml into a file and use the DOMRequest
            // to load it.
    ...
    public void testXpath_node_count() {
        ...
        assertEquals("function:xpath-node-count More than one Content section for id 'urn:oasis:names:tc:xacml:3.0:attribute-category:resource'",
        ...
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-count Got null EvaluationContext", res.getStatus()
            .getStatusMessage());
        ...
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-count Got null Request in EvaluationContext", res.getStatus()
            .getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:processing-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
        ...
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-count Got null attribute at arg index 0", res.getStatus()
            .getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:processing-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
        ...
        res = fd.evaluate(new StdEvaluationContext(requestEmpty, null, null), arguments);
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-count XPathExpression returned null at index 0", res.getStatus()
            .getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:processing-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
        ...
        res = fd.evaluate(new StdEvaluationContext(requestEmpty, null, null), arguments);
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-count Got null Category at index 0", res.getStatus()
            .getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:syntax-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
        ...
        res = fd.evaluate(null, arguments);
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-count Expected 1 arguments, got 2", res.getStatus()
            .getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:processing-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
        ...
        res = fd.evaluate(null, arguments);
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-count Expected 1 arguments, got 0", res.getStatus()
            .getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:processing-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
        ...
        res = fd.evaluate(null, arguments);
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-count Expected data type 'xpathExpression' saw 'string' at arg index 0",
                     res.getStatus().getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:processing-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
        ...
        res = fd.evaluate(null, arguments);
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-count Got null argument at arg index 0", res.getStatus()
            .getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:processing-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
    ...
    public void testXpath_node_equal() {
        ...
        res = fd.evaluate(new StdEvaluationContext(requestDoubleResources, null, null), arguments);
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-equal More than one Content section for id 'urn:oasis:names:tc:xacml:3.0:attribute-category:resource'",
                     res.getStatus().getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:syntax-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
        ...
        res = fd.evaluate(null, arguments);
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-equal Got null EvaluationContext", res.getStatus()
            .getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:processing-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
        ...
        res = fd.evaluate(new StdEvaluationContext(null, null, null), arguments);
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-equal Got null Request in EvaluationContext", res.getStatus()
            .getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:processing-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
        ...
        res = fd.evaluate(new StdEvaluationContext(requestEmpty, null, null), arguments);
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-equal Got null attribute at arg index 0", res.getStatus()
            .getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:processing-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
        ...
        res = fd.evaluate(new StdEvaluationContext(requestEmpty, null, null), arguments);
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-equal Got null attribute at arg index 1", res.getStatus()
            .getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:processing-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
        ...
        res = fd.evaluate(new StdEvaluationContext(requestEmpty, null, null), arguments);
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-equal XPathExpression returned null at index 0", res.getStatus()
            .getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:processing-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
        ...
        res = fd.evaluate(new StdEvaluationContext(requestEmpty, null, null), arguments);
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-equal Got null Category at index 0", res.getStatus()
            .getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:syntax-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
        ...
        res = fd.evaluate(null, arguments);
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-equal Expected 2 arguments, got 3", res.getStatus()
            .getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:processing-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
        ...
        res = fd.evaluate(null, arguments);
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-equal Expected 2 arguments, got 0", res.getStatus()
            .getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:processing-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
        ...
        res = fd.evaluate(null, arguments);
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-equal Expected 2 arguments, got 1", res.getStatus()
            .getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:processing-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
        ...
        res = fd.evaluate(null, arguments);
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-equal Expected data type 'xpathExpression' saw 'string' at arg index 0",
                     res.getStatus().getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:processing-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
        ...
        res = fd.evaluate(null, arguments);
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-equal Expected data type 'xpathExpression' saw 'string' at arg index 1",
                     res.getStatus().getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:processing-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
        ...
        res = fd.evaluate(null, arguments);
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-equal Got null argument at arg index 1", res.getStatus()
            .getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:processing-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
        ...
        res = fd.evaluate(null, arguments);
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-equal Got null argument at arg index 0", res.getStatus()
            .getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:processing-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
    ...
    public void testXpath_node_match() {
        ...
        res = fd.evaluate(new StdEvaluationContext(requestDoubleResources, null, null), arguments);
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-match More than one Content section for id 'urn:oasis:names:tc:xacml:3.0:attribute-category:resource'",
                     res.getStatus().getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:syntax-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
        ...
        res = fd.evaluate(null, arguments);
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-match Got null EvaluationContext", res.getStatus()
            .getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:processing-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
        ...
        res = fd.evaluate(new StdEvaluationContext(null, null, null), arguments);
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-match Got null Request in EvaluationContext", res.getStatus()
            .getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:processing-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
        ...
        res = fd.evaluate(new StdEvaluationContext(requestEmpty, null, null), arguments);
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-match Got null attribute at arg index 0", res.getStatus()
            .getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:processing-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
        ...
        res = fd.evaluate(new StdEvaluationContext(requestEmpty, null, null), arguments);
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-match Got null attribute at arg index 1", res.getStatus()
            .getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:processing-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
        ...
        res = fd.evaluate(new StdEvaluationContext(requestEmpty, null, null), arguments);
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-match XPathExpression returned null at index 0", res.getStatus()
            .getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:processing-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
        ...
        res = fd.evaluate(new StdEvaluationContext(requestEmpty, null, null), arguments);
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-match Got null Category at index 0", res.getStatus()
            .getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:syntax-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
        ...
        res = fd.evaluate(null, arguments);
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-match Expected 2 arguments, got 3", res.getStatus()
            .getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:processing-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
        ...
        res = fd.evaluate(null, arguments);
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-match Expected 2 arguments, got 0", res.getStatus()
            .getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:processing-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
        ...
        res = fd.evaluate(null, arguments);
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-match Expected 2 arguments, got 1", res.getStatus()
            .getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:processing-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
        ...
        res = fd.evaluate(null, arguments);
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-match Expected data type 'xpathExpression' saw 'string' at arg index 0",
                     res.getStatus().getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:processing-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
        ...
        res = fd.evaluate(null, arguments);
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-match Expected data type 'xpathExpression' saw 'string' at arg index 1",
                     res.getStatus().getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:processing-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
        ...
        res = fd.evaluate(null, arguments);
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-match Got null argument at arg index 1", res.getStatus()
            .getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:processing-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
        ...
        res = fd.evaluate(null, arguments);
        assertFalse(res.getStatus().isOk());
        assertEquals("function:xpath-node-match Got null argument at arg index 0", res.getStatus()
            .getStatusMessage());
        assertEquals("urn:oasis:names:tc:xacml:1.0:status:processing-error", res.getStatus().getStatusCode()
            .getStatusCodeValue().stringValue());
    ...
    // are NOT supported due to ambiguity in the semantics between 2.0 (<Request> is root and has only one
