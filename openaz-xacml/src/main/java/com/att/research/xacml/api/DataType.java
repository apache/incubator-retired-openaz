...
public interface DataType<T> {
    /**
     * Gets the {@link com.att.research.xacml.api.Identifier} representing the XACML data type id for this
     * <code>DataType</code>.
     *
    ...
    /**
     * Converts the given <code>Object</code> to a {@link com.att.research.xacml.api.AttributeValue} whose
    ...
    /**
     * Converts the given {@link com.att.research.xacml.api.AttributeValue} of an unknown data type to an
