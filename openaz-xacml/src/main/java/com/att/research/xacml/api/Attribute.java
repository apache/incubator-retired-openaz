...
public interface Attribute {
    /**
     * Gets the {@link com.att.research.xacml.api.Identifier} for this <code>Attribute</code> object. The
    ...
    /**
     * Gets the {@link com.att.research.xacml.api.Identifier} for the XACML 3.0 Category of this
     * <code>Attribute</code>.
     *
    ...
    /**
     * Gets the <code>Collection</code> of {@link com.att.research.xacml.api.AttributeValue} objects for this
     * <code>Attribute</code>. If there are no <code>AttributeValue</code>s in this <code>Attribute</code>, an
     * empty <code>Collection</code> must be returned. The returned <code>Collection</code> should not be
     * modified. Implementations are free to return an immutable view to enforce this.
     *
    ...
    /**
     * Finds all of the {@link com.att.research.xacml.api.AttributeValue} objects with the given
     * {@link DataType} in the <code>AttributeValue</code>s for this <code>Attribute</code>. If there are no
     * matching <code>AttributeValue</code>s, an empty <code>Iterator</code> must be returned.
     *
