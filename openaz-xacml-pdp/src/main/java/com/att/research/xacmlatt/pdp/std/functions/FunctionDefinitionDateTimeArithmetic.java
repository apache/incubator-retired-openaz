 ...
 * dateTime-subtract-dayTimeDuration dateTime-subtract-yearMonthDuration date-add-yearMonthDuration
 * date-subtract-yearMonthDuration
 *
 * @param <I> the java class for the data type of the function Input arguments; SPECIAL CASE: this applies ONLY
 *            to the 2nd argument.
 * @param <O> the java class for the data type of the function Output; SPECIAL CASE: this ALSO applies to the
 *            type of the 1st Input argument.
 */
public class FunctionDefinitionDateTimeArithmetic<O extends IDateTime<O>, I extends ISO8601Duration> extends
     ...
     */
    public FunctionDefinitionDateTimeArithmetic(Identifier idIn, DataType<O> dataTypeIn,
    ...
    public ExpressionResult evaluate(EvaluationContext evaluationContext, List<FunctionArgument> arguments) {
        ...
        ConvertedArgument<O> convertedArgument0 = new ConvertedArgument<O>(functionArgument,
                                                                           this.getDataType(), false);
        ...
        try {
            expressionResult = ExpressionResult.newSingle(this.getDataType()
                .createAttributeValue(idateResult));
