 ...
 * boolean-from-string string-from-boolean integer-from-string string-from-integer double-from-string
 * string-from-double time-from-string string-from-time date-from-string string-from-date dateTime-from-string
 * string-from-dateTime anyURI-from-string string-from-anyURI dayTimeDuration-from-string
 * string-from-dayTimeDuration yearMonthDuration-from-string string-from-yearMonthDuration
 * x500Name-from-string string-from-x500Name rfc822Name-from-string string-from-rfc822Name
 * ipAddress-from-string string-from-ipAddress dnsName-from-string string-from-dnsName
 *
        ...
        if (this.getDataTypeId().equals(DataTypes.DT_STRING.getId())) {
            ...
            try {
                ...
                return ExpressionResult
                    .newSingle(new StdAttributeValue<String>(this.getDataTypeId(), output));
            } catch (Exception e) {
