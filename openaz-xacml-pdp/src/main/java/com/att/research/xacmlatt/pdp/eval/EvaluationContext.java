 ...
 * against a {@link com.att.research.xacml.api.Request}.
 */
public interface EvaluationContext extends PIPFinder, TraceEngine {
    ...
    /**
     * Gets the root {@link com.att.research.xacmlatt.pdp.policy.PolicyDef} from the policy store configured
    ...
    /**
     * Gets the {@link com.att.research.xacmlatt.pdp.policy.Policy} that matches the given
     * {@link com.att.research.xacml.api.IdReferenceMatch}.
     *
    ...
    /**
     * Gets the {@link com.att.research.xacmlatt.pdp.policy.PolicySet} that matches the given
     * {@link com.att.research.xacml.api.IdReferenceMatch}.
     *
     * @param idReferenceMatch the <code>IdReferenceMatch</code> to search for
    ...
    /**
     * Gets the {@link com.att.research.xacml.api.pip.PIPResponse} containing
     * {@link com.att.research.xacml.api.Attribute}s that match the given
     * {@link com.att.research.xacml.api.pip.PIPRequest} from this <code>EvaluationContext</code>.
     *
     * @param pipRequest the <code>PIPRequest</code> specifying which <code>Attribute</code>s to retrieve
     * @return the <code>PIPResponse</code> containing the {@link com.att.research.xacml.api.Status} and
