...
public interface JDBCResolver extends ConfigurableResolver {
     ...
     *
     * @param pipEngine the {@link com.att.research.xacml.api.pip.PIPEngine} making the request for XACML
     *            AttributeValues
     * @param pipRequest the {@link com.att.research.xacml.api.pip.PIPRequest} with the requested XACML
     *            Attributes
     * @param pipFinder the {@link com.att.research.xacml.api.pip.PIPFinder} for finding any other XACML
    ...
    /**
     * Creates a <code>List</code> of {@link com.att.research.xacml.api.Attribute}s from the given
