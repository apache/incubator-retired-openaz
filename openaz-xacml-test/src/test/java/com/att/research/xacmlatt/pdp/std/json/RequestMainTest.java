...
/**
 * Test JSON Request convert to object - High-level Request-as-a-whole tests including test that fills in all
 * fields with multiple values (where appropriate) TO RUN - use jUnit In Eclipse select this file or the
 * enclosing directory, right-click and select Run As/JUnit Test NOTE: The "correct" way to verify that each
 * JSON string gets translated into our internal Objects correctly is to look explicitly at each of the child
 * objects and verify that they are correct. This would involve a lot of coding to get child of child of child
 * and individually verify each property of each element. To simplify testing we assume that
 * request.toString() correctly includes a complete text representation of every sub-component of the Request
 * object and we compare the resulting String to our expected String. This has two possible sources of error:
 * - toString might not include some sub-component, and - the initial verification of the resulting string is
 * done by hand and may have been incorrect.
 */
public class RequestMainTest {
    ...
    public void testEmptyRequest() {
        ...
        // garbage input
        try {
            request = JSONRequest.load("Some non-JSON string");
            fail("Request should throw exception");
        } catch (JSONStructureException e) {
            // correct response
        } catch (Exception e) {
        ...
        try {
            request = JSONRequest.load("{something non-JSON}");
            fail("Request should throw exception");
        } catch (JSONStructureException e) {
            // correct response
        } catch (Exception e) {
        ...
        try {
            request = JSONRequest.load("{\"Request\" : \"CombinedDecision\" : true }");
            fail("Request should throw exception");
        } catch (JSONStructureException e) {
            // correct response
        } catch (Exception e) {
        ...
        try {
            request = JSONRequest
                .load("{\"Request\" : {\"XPathVersion\" : \"http://www.w3.org/TR/1999/REC-xpath-19991116\"}}}}}");
            assertEquals("{requestDefaults={xpatherVersion=http://www.w3.org/TR/1999/REC-xpath-19991116},returnPolicyIdList=false,combinedDecision=false}",
                         request.toString());
        } catch (Exception e) {
            fail("Failed convert from JSON to object: " + e);
        }
    ...
    public void testMissingFields() {
        ...
        try {
            request = JSONRequest
                .load("{\" Request\" : {\"XPathVersion\" : \"http://some/other/default/uri\" }}");
            fail("Request should throw exception");
        } catch (JSONStructureException e) {
            // correct response
        } catch (Exception e) {
    ...
    public void testTopLevelElements() {
        ...
        // ReturnPolicyIdList
        try {
            request = JSONRequest.load("{\"Request\" : {\"ReturnPolicyIdList\" : true  }}");
        ...
        try {
            request = JSONRequest.load("{\"Request\" : {\"ReturnPolicyIdList\" : \"abc\"  }}");
            fail("Request should throw exception");
        } catch (JSONStructureException e) {
            // correct response
        } catch (Exception e) {
        ...
        try {
            request = JSONRequest.load("{\"Request\" : {\"ReturnPolicyIdList\" : 123  }}");
            fail("Request should throw exception");
        } catch (JSONStructureException e) {
            // correct response
        } catch (Exception e) {
        ...
        try {
            request = JSONRequest.load("{\"Request\" : {\"CombinedDecision\" : \"abc\"  }}");
            fail("Request should throw exception");
        } catch (JSONStructureException e) {
            // correct response
        } catch (Exception e) {
        ...
        try {
            request = JSONRequest.load("{\"Request\" : {\"CombinedDecision\" : 123  }}");
            fail("Request should throw exception");
        } catch (JSONStructureException e) {
            // correct response
        } catch (Exception e) {
        ...
        try {
            request = JSONRequest
                .load("{\"Request\" : {\"XPathVersion\" : \"http://some/other/default/uri\" }}");
            assertEquals("{requestDefaults={xpatherVersion=http://some/other/default/uri},returnPolicyIdList=false,combinedDecision=false}",
                         request.toString());
        } catch (Exception e) {
            fail("Failed convert from JSON to object: " + e);
        }
        ...
        try {
            request = JSONRequest.load("{\"Request\" : {\"XPathVersion\" : true  }}");
            fail("Request should throw exception");
        } catch (JSONStructureException e) {
            // correct response
        } catch (Exception e) {
        ...
        try {
            request = JSONRequest.load("{\"Request\" : {\"XPathVersion\" : 123  }}");
            fail("Request should throw exception");
        } catch (JSONStructureException e) {
            // correct response
        } catch (Exception e) {
        ...
        try {
            request = JSONRequest.load("{\"Request\" : {\"XPathVersion\" : \"not a uri\" }}");
            fail("Request should throw exception");
        } catch (JSONStructureException e) {
            // correct response
        } catch (Exception e) {
        ...
        try {
            request = JSONRequest
                .load("{\"Request\" : {\"Category\": [{ " + "\"CategoryId\": \"another-custom-cat\", "
                      + "\"Id\" : \"anotherXmlId\", " + "\"Attribute\" : []" + "} " + "] }}");
            assertEquals("{returnPolicyIdList=false,combinedDecision=false,requestAttributes=[{super={category=another-custom-cat},xmlId=anotherXmlId}]}",
                         request.toString());
        } catch (Exception e) {
            fail("Failed convert from JSON to object: " + e);
        }
        ...
        try {
            ...
            assertEquals("{returnPolicyIdList=false,combinedDecision=false,requestAttributes=[{super={category=urn:oasis:names:tc:xacml:3.0:attribute-category:action}}]}",
                         request.toString());
        } catch (Exception e) {
            fail("Failed convert from JSON to object: " + e);
        }
        ...
        try {
            ...
            assertEquals("{returnPolicyIdList=false,combinedDecision=false,requestAttributes=[{super={category=urn:oasis:names:tc:xacml:3.0:attribute-category:resource}}]}",
                         request.toString());
        } catch (Exception e) {
            fail("Failed convert from JSON to object: " + e);
        }
        ...
        try {
            ...
            assertEquals("{returnPolicyIdList=false,combinedDecision=false,requestAttributes=[{super={category=urn:oasis:names:tc:xacml:3.0:attribute-category:environment}}]}",
                         request.toString());
        } catch (Exception e) {
            fail("Failed convert from JSON to object: " + e);
        }
        ...
        // MultiRequests
        try {
            request = JSONRequest.load("{\"Request\" : {\"MultiRequests\" : {" + "\"RequestReference\": ["
                                       + "{ " + "\"ReferenceId\" : [\"foo1\",\"bar1\"]" + "}," + "{"
                                       + "\"ReferenceId\" : [\"foo2\",\"bar2\"]" + "}]" + "} } }");
            assertEquals("{returnPolicyIdList=false,combinedDecision=false,multiRequests=[{requestAttributesReferences=[{referenceId=foo1}{referenceId=bar1}]}{requestAttributesReferences=[{referenceId=foo2}{referenceId=bar2}]}]}",
                         request.toString());
        } catch (Exception e) {
            fail("Failed convert from JSON to object: " + e);
        }
        ...
        try {
            request = JSONRequest.load("{\"Request\" : {\"MultiRequests\" : {" + "\"RequestReference\": ["
                                       + "{" + "\"ReferenceId\" : [\"bar2\"]" + "}]" + "} } }");
            assertEquals("{returnPolicyIdList=false,combinedDecision=false,multiRequests=[{requestAttributesReferences=[{referenceId=bar2}]}]}",
                         request.toString());
        } catch (Exception e) {
            fail("Failed convert from JSON to object: " + e);
        }
        ...
        try {
            request = JSONRequest.load("{\"Request\" : {\"MultiRequests\" : {"
        ...
        try {
            request = JSONRequest.load("{\"Request\" : {\"MultiRequests\" : {"
                                       + "\"SomeOtherAttribute\": 123," + "\"RequestReference\": [" + "{ "
                                       + "\"ReferenceId\" : [\"foo1\",\"bar1\"]" + "}," + "{"
                                       + "\"ReferenceId\" : [\"foo2\",\"bar2\"]" + "}]" + "} } }");
            fail("Request should throw exception");
        } catch (JSONStructureException e) {
        ...
        // Cannot test with ReferenceId that is NOT referring to a Category object Id property because we may
        // not have read the Category objects yet.
        // Need to leave this up to the PDP.

        // extra elements in top-level
        try {
            request = JSONRequest
                .load("{\"Request\" : {}, \"unknownElement\" : false, \"unk2\" : \"abc\", \"unk3\" : 123 }}");
        ...
        try {
            request = JSONRequest
                .load("{\"Request\" : {\"XPathVersion\" : \"http://www.w3.org/TR/1999/REC-xpath-19991116\", \"unknownElement\" : false }}");
            fail("Unknown element should throw exception");
        } catch (JSONStructureException e) {
            // correct response
        } catch (Exception e) {
    ...
    public void testDuplicates() {
        // duplicate Request
        try {
            request = JSONRequest.load("{\"Request\" : {}, \"Request\" : {}}");
            fail("Unknown element should throw exception");
        } catch (JSONStructureException e) {
            // correct response
        } catch (Exception e) {
        ...
        try {
            request = JSONRequest
                .load("{\"Request\" : {\"ReturnPolicyIdList\" : true, \"ReturnPolicyIdList\" : true   }}");
            fail("Unknown element should throw exception");
        } catch (JSONStructureException e) {
            // correct response
        } catch (Exception e) {
        ...
        try {
            request = JSONRequest
                .load("{\"Request\" : { \"CombinedDecision\" : true, \"CombinedDecision\" : true }}");
            fail("Unknown element should throw exception");
        } catch (JSONStructureException e) {
            // correct response
        } catch (Exception e) {
        ...
        try {
            request = JSONRequest
                .load("{\"Request\" : {\"Category\": [{ " + "\"CategoryId\": \"another-custom-cat\", "
                      + "\"Id\" : \"anotherXmlId\", " + "\"Attribute\" : []" + "} " + "],"
                      + "\"Category\": [{ " + "\"CategoryId\": \"another-custom-cat\", "
                      + "\"Id\" : \"anotherXmlId\", " + "\"Attribute\" : []" + "} " + "] }}");
            assertEquals("{returnPolicyIdList=false,combinedDecision=false,requestAttributes=[{super={category=another-custom-cat},xmlId=anotherXmlId}]}",
                         request.toString());
            fail("Unknown element should throw exception");
        ...
        try {
            request = JSONRequest
                .load("{\"Request\" : {\"Category\": [{ " + "\"CategoryId\": \"another-custom-cat\", "
                      + "\"CategoryId\": \"another-custom-cat\", " + "\"Id\" : \"anotherXmlId\", "
                      + "\"Attribute\" : []" + "} " + "] }}");
            fail("Unknown element should throw exception");
        } catch (JSONStructureException e) {
            // correct response
        ...
        try {
            request = JSONRequest.load("{\"Request\" : {\"Category\": [{ "
                                       + "\"CategoryId\": \"another-custom-cat\", "
                                       + "\"Id\" : \"anotherXmlId\", " + "\"Id\" : \"anotherXmlId\", "
                                       + "\"Attribute\" : []" + "} " + "] }}");
            fail("Unknown element should throw exception");
        } catch (JSONStructureException e) {
            // correct response
        ...
        // AccessSubject
        try {
            request = JSONRequest.load("{\"Request\" : { \"AccessSubject\":{ }, \"AccessSubject\":{ }}}");
            fail("Unknown element should throw exception");
        } catch (JSONStructureException e) {
            // correct response
        } catch (Exception e) {
        ...
        // Action
        try {
            request = JSONRequest.load("{\"Request\" : { \"Action\":{ }, \"Action\":{ }}}");
            fail("Unknown element should throw exception");
        } catch (JSONStructureException e) {
            // correct response
        } catch (Exception e) {
        ...
        // Resource
        try {
            request = JSONRequest.load("{\"Request\" : {\"Resource\":{ }, \"Resource\":{ }}}");
            fail("Unknown element should throw exception");
        } catch (JSONStructureException e) {
            // correct response
        } catch (Exception e) {
        ...
        // Environment
        try {
            request = JSONRequest.load("{\"Request\" : {\"Environment\":{ }, \"Environment\":{ } }}");
            fail("Unknown element should throw exception");
        } catch (JSONStructureException e) {
            // correct response
        } catch (Exception e) {
