 ...
 * for each XACML Function. This release combines multiple Functions in fewer files to minimize code
 * duplication. This file supports the following XACML codes: string-is-in boolean-is-in integer-is-in
 * double-is-in time-is-in date-is-in dateTime-is-in anyURI-is-in hexBinary-is-in base64Binary-is-in
 * dayTimeDuration-is-in (version 1 and3) yearMonthDuration-is-in (version 1 and 3) x500Name-is-in
 * rfc822Name-is-in ipAddress-is-in dnsName-is-in
 *
 * @param <I> the java class for the data type of the elements in the Input argument Bag The Output for these
 *            functions is always a Boolean.
 */
public class FunctionDefinitionBagIsIn<I> extends FunctionDefinitionBase<Boolean, I> {
    ...
    public ExpressionResult evaluate(EvaluationContext evaluationContext, List<FunctionArgument> arguments) {
        ...
        ConvertedArgument<I> convertedTargetArgument = new ConvertedArgument<I>(elementArgument,
        ...
        while (iterBagContents.hasNext()) {
             ...
             * are not of the right type? The spec does not say this, so we just use the
             * AttributeValue.equals() method for now.
             */
